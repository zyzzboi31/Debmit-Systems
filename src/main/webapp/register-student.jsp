...
<head>
  ...
  <title>CEMK — Register Student</title>
  ...
  <style>
    *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
    ...
    .form-card-header {
      padding:18px 24px 16px; border-bottom:1px solid var(--border); position:relative;
    }
    ...
    input[type="text"]:focus, input[type="number"]:focus {
      border-color:var(--accent-dim); box-shadow:0 0 0 3px rgba(200,240,74,0.08);
    }
...
<div class="page-wrap">
  ...
  <main class="main">
    ...
    <h1 class="page-title">Register <span>Student</span></h1>
    <p class="page-sub">// Add a new student record to the system</p>

    <div class="form-card">
      <div class="form-card-header">
        <div class="form-card-title">Student Registration Form</div>
      </div>
      <div class="form-card-body">
        <form action="view-all-students.jsp" method="get">
          <div class="form-group">
            <label for="sid">Student ID</label>
            <input type="text" id="sid" name="id" placeholder="e.g. STU001" required />
          </div>
          <div class="form-group">
            <label for="sname">Full Name</label>
            <input type="text" id="sname" name="name" placeholder="e.g. Arjun Sharma" required />
          </div>
          <div class="form-group">
            <label for="semail">Email Address</label>
            <input type="text" id="semail" name="email" placeholder="e.g. arjun@email.com" required />
          </div>
          <div class="form-group">
            <label for="scity">City</label>
            <input type="text" id="scity" name="city" placeholder="e.g. Kolkata" required />
          </div>
          <div class="form-group">
            <label for="sage">Age</label>
            <input type="number" id="sage" name="age" placeholder="e.g. 20" min="1" max="99" required />
          </div>
          <div class="form-divider"></div>
          <div class="form-actions">
            <button type="submit" class="btn-primary"><span>Register Student &rarr;</span></button>
